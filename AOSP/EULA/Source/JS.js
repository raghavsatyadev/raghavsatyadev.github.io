...
(function(e, t) {
    ...
    function _(e, t) {
        for (var n, i, r, o = [], s = 0, a = e.length; a > s; s++)
            ...
            i.style.display === "" && _t(i) && (o[s] = rt._data(i, "olddisplay", S(i.nodeName)))) : (r = _t(i),
    ...
    function M(e, t, n) {
        var i, r, o, s, a, l, c, u, d = this, p = {}, h = e.style, f = e.nodeType && _t(e), m = rt._data(e, "fxshow");
    ...
    function O(e, t, n) {
        var i, r, o = 0, s = bn.length, a = rt.Deferred().always(function() {
            ...
            if (r)
                return !1;
            for (var t = fn || P(), n = Math.max(0, c.startTime + c.duration - t), i = n / c.duration || 0, o = 1 - i, s = 0, l = c.tweens.length; l > s; s++)
                c.tweens[s].run(o);
 ...
 */
    function(e) {
        function t(e, t, n, i) {
            ...
            if ((t ? t.ownerDocument || t : z) !== L && j(t),
            t = t || L,
            n = n || [],
            !e || "string" != typeof e)
                return n;
        ...
        function y(e) {
            for (var t, n, i, r = e.length, o = T.relative[e[0].type], s = o || T.relative[" "], a = o ? 1 : 0, l = h(function(e) {
                ...
                return !o && (i || n !== _) || ((t = n).nodeType ? l(e, n, i) : c(e, n, i))
            }
            ]; r > a; a++)
        ...
        function b(e, n) {
            var r = n.length > 0
              ...
              , s = function(i, s, a, l, c) {
                var u, d, p, h = 0, f = "0", m = i && [], v = [], y = _, b = i || o && T.find.TAG("*", c), x = R += null == y ? 1 : Math.random() || .1, w = b.length;
                for (c && (_ = s !== L && s); f !== w && (u = b[f]) != null; f++) {
                    if (o && u) {
                        for (d = 0; p = e[d++]; )
                            if (p(u, s, a)) {
                                l.push(u);
        ...
        var x, w, T, E, k, S, C, N, _, A, D, j, L, P, H, q, M, F, O, B = "sizzle" + -new Date, z = e.document, R = 0, W = 0, X = n(), I = n(), $ = n(), Y = function(e, t) {
            return e === t && (D = !0),
            0
        ...
        j = t.setDocument = function(e) {
            ...
            return n !== L && n.nodeType === 9 && n.documentElement ? (L = n,
            P = n.documentElement,
            H = !k(n),
            ...
            (w.qsa = vt.test(n.querySelectorAll)) && (r(function(e) {
                ...
                e.querySelectorAll("[msallowclip^='']").length && q.push("[*^$]=" + it + "*(?:''|\"\")"),
            ...
            (w.matchesSelector = vt.test(F = P.matches || P.webkitMatchesSelector || P.mozMatchesSelector || P.oMatchesSelector || P.msMatchesSelector)) && r(function(e) {
            ...
            Y = t ? function(e, t) {
                ...
                1 & i || !w.sortDetached && t.compareDocumentPosition(e) === i ? e === n || e.ownerDocument === z && O(z, e) ? -1 : t === n || t.ownerDocument === z && O(z, t) ? 1 : A ? tt.call(A, e) - tt.call(A, t) : 0 : 4 & i ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return D = !0,
        ...
        t.matchesSelector = function(e, n) {
            ...
            n = n.replace(dt, "='$1']"),
            !(!w.matchesSelector || !H || M && M.test(n) || q && q.test(n)))
                try {
                    var i = F.call(e, n);
        ...
        w.sortDetached = r(function(e) {
            return e.compareDocumentPosition(L.createElement("div")) & 1
        }),
        r(function(e) {
    ...
    rt.event = {
        ...
        fix: function(e) {
            ...
            for (s || (this.fixHooks[r] = s = Pt.test(r) ? this.mouseHooks : Lt.test(r) ? this.keyHooks : {}),
    ...
    nt.changeBubbles || (rt.event.special.change = {
        setup: function() {
            return jt.test(this.nodeName) ? ((this.type === "checkbox" || this.type === "radio") && (rt.event.add(this, "propertychange._change", function(e) {
    ...
    rt.extend({
        clone: function(e, t, n) {
            ...
            if (nt.html5Clone || rt.isXMLDoc(e) || !Ot.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Gt.innerHTML = e.outerHTML,
    ...
    rt.fn.extend({
        ...
        html: function(e) {
            return At(this, function(e) {
                ...
                if (!("string" != typeof e || It.test(e) || !nt.htmlSerialize && Ot.test(e) || !nt.leadingWhitespace && Bt.test(e) || Kt[(Rt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(zt, "<$1></$2>");
                    try {
                        for (; i > n; n++)
                            t = this[n] || {},
    ...
    rt.each(["height", "width"], function(e, t) {
        rt.cssHooks[t] = {
            ...
            set: function(e, n, i) {
                var r = i && en(e);
                return A(e, n, i ? D(e, t, i, nt.boxSizing && rt.css(e, "boxSizing", !1, r) === "border-box", r) : 0)
            }
        }
    }),
    ...
    rt.fx.step = {};
    var fn, mn, gn = /^(?:toggle|show|hide)$/, vn = new RegExp("^(?:([+-])=|)(" + Ct + ")([a-z%]*)$","i"), yn = /queueHooks$/, bn = [M], xn = {
        "*": [function(e, t) {
    ...
    rt.extend({
        ...
        ajax: function(e, t) {
            ...
            w.success = w.done,
            w.error = w.fail,
            d.url = ((e || d.url || qn) + "").replace(Mn, "").replace(Rn, Hn[1] + "//"),
            ...
            o = d.url,
            d.hasContent || (d.data && (o = d.url += (Ln.test(o) ? "&" : "?") + d.data,
            delete d.data),
            d.cache === !1 && (d.url = Fn.test(o) ? o.replace(Fn, "$1_=" + jn++) : o + (Ln.test(o) ? "&" : "?") + "_=" + jn++)),
    ...
    rt.ajaxPrefilter("json jsonp", function(t, n, i) {
        ...
        a ? t[a] = t[a].replace(ni, "$1" + r) : t.jsonp !== !1 && (t.url += (Ln.test(t.url) ? "&" : "?") + t.jsonp + "=" + r),
